...
env = environ.Env(
    DEBUG=(bool, False)  # Define expected types
)
...
SECRET_KEY = "django-insecure-eibrp*^!om-)%@e8%@#y076x(+l3=j1a%l#km(gthrom$!ok=h"
...
DATABASES = {
    'default': {
        ...
        'HOST': 'dbset.cngg8aym2aze.ap-south-1.rds.amazonaws.com',
